// lib/features/inspection/widgets/met_element_card.dart
...
class MetElementCard extends StatefulWidget {
  final int elementIndex;
  final MetElementMeta meta;
  final MetElementScore score;
  final ValueChanged<MetElementScore> onChanged;

  const MetElementCard({
    super.key,
  ...
  @override
  State<MetElementCard> createState() => _MetElementCardState();
}

class _MetElementCardState extends State<MetElementCard>
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // ── تنبيه السلامة ─────────────────────────────
                        _MetSafetyBanner(note: meta.safetyNoteAr, score: s),
...
class _MetSubCriteriaSection extends StatelessWidget {
  final MetElementMeta meta;
  final Map<String, bool> checked;
  final void Function(String key, bool val) onChanged;

  const _MetSubCriteriaSection({
    required this.meta,
...
class _MetSafetyBanner extends StatelessWidget {
  final String note;
  final int score;
  const _MetSafetyBanner({required this.note, required this.score});
