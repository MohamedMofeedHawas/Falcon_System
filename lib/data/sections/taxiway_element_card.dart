...
class _TaxiwayElementCardState extends State<TaxiwayElementCard>
  ...
  @override
  void didUpdateWidget(TaxiwayElementCard oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (widget.score.key != oldWidget.score.key) {
      _notesController.text = widget.score.notes;
      return;
    }
    if (widget.score.notes != oldWidget.score.notes &&
        widget.score.notes != _notesController.text) {
      _notesController.text = widget.score.notes;
    }
  }
  ...
  Widget build(BuildContext context) {
    final s = widget.score.score.clamp(0, 10);
